...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=00FFFF&center=true&vCenter=true&width=800&lines=Designing+databases+and+managing+software+projects" alt="Typing Text Animation" />
</div>
<!-- Tiêu đề About Me -->
## 👨‍💻 About Me
...
*   **Web Development:** ASP.NET MVC, .NET Core (.NET 6.0 - 9.0), WordPress
*   **Database Administration:** SQL Server, Oracle
*   **Blockchain & DApps:** Solidity, Smart Contracts
*   **UI/UX & Integration:** Gradio
*   **Project Management:** SOW (Statement of Work), Business Rules Analysis, System Design
